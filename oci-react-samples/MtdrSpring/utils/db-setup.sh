...
CREATE TABLE TODOUSER.TASKSTATUS (
...
CREATE TABLE TODOUSER.USERTYPE (
    UserTypeId NUMBER PRIMARY KEY,
    Name NVARCHAR2(100),
    Description NVARCHAR2(200)
);
CREATE TABLE TODOUSER.USERTEAM (
...
CREATE TABLE TODOUSER.TEAMTYPE (
    TeamTypeId NUMBER PRIMARY KEY,
    Name NVARCHAR2(100),
    Description NVARCHAR2(200)
);
CREATE TABLE TODOUSER.TASKUPDATE (
...
CREATE TABLE TODOUSER.UPDATETYPE (
    UpdateTypeId NUMBER PRIMARY KEY,
    Name NVARCHAR2(100),
    Description NVARCHAR2(200)
);
CREATE TABLE TODOUSER.SPRINTUPDATE (
