...
GRANT SELECT ON DBA_USERS TO $U;
...
CREATE TABLE SPRINT (SprintId NUMBER PRIMARY KEY, Name NVARCHAR2(100), Description NVARCHAR2(500), StartDate DATE, EndDate DATE, ProjectId NUMBER REFERENCES PROJECT(ProjectId)) on $U;
